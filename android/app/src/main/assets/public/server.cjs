    ...
    try {
      ...
      const response = await ai.models.generateContent({
        ...
        config: {
          ...
          responseSchema: {
            ...
            properties: {
              caption: { type: import_genai.Type.STRING, description: "A highly humorous caption to describe the meme or situation." },
              topText: { type: import_genai.Type.STRING, description: "Punchy, relatable text overlay on the top of the meme." },
              bottomText: { type: import_genai.Type.STRING, description: "Punchy, relatable text overlay on the bottom." },
              tags: {
      ...
      if (responseText) {
        ...
        const newMeme = {
          ...
          commentsCount: 2,
          comments: [
            { username: "GeminiBot", avatar: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=100&auto=format&fit=crop&q=60", text: "I generated this setup with pure algorithmic love \u{1F602}", timestamp: "Just now" },
